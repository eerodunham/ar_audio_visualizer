...
public struct FFTProperties
{
    ...
    public static unsafe bool TryCreate<T>(in ReadOnlySpan<float> signal, in ReadOnlySpan<float2> complex, T str, out FFTProperties props) where T : unmanaged, IUTF8Bytes
    {
        props = default;
